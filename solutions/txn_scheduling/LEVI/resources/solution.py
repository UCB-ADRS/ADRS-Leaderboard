...
def get_random_costs() -> tuple:
    ...
    _, schedule1 = get_best_schedule(workload1)
    cost1 = workload1.get_opt_seq_cost(schedule1)

    workload2 = Workload(WORKLOAD_2)
    _, schedule2 = get_best_schedule(workload2)
    cost2 = workload2.get_opt_seq_cost(schedule2)

    workload3 = Workload(WORKLOAD_3)
    _, schedule3 = get_best_schedule(workload3)
...
class Solution:
    """LEVI submission for txn_scheduling."""
